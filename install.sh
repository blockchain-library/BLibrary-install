#!/bin/bash
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='blibrary.conf'
CONFIGFOLDER='/root/.blibrary/'
COIN_DAEMON='/usr/local/bin/blibraryd'
COIN_CLI='/usr/local/bin/blibrary-cli'
COIN_REPO='https://github.com/blockchain-library/BLibrary/releases/download/v1.0.1.1/BLibrary-Daemon.v1.0.1.1.tar.gz'
COIN_NAME='blibrary'
COIN_PORT=33600
RPC_PORT=48000
